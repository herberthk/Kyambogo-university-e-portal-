...
$sql7 = "SELECT admin_id, password FROM admin WHERE admin_id = ?";
						...
						<div class="x_panel">
							...
							<div class="x_content">
								<table id="datatable-buttons" class="table table-hover table-bordered">
									...
									<tbody>
										<?php
										$sql = "SELECT id,faculty_id,faculty_Fname,faculty_Mname,faculty_Lname,Email,Contact_num,Department,Designation,Campus,course_program FROM faculty WHERE status = 0";
	...
	<div class="modal fade" id="set_deadline" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<?php 
					$sql1 = "SELECT status FROM deadline ORDER BY id DESC LIMIT 1";
